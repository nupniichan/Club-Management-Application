...
class _StudentMemberManagementScreenState extends State<StudentMemberManagementScreen> {
  ...
  void _updateMember() {
    if (_formKey.currentState!.validate() && _editingMember != null) {
      ...
      setState(() {
        final index = _members.indexWhere((m) => m['id'] == _editingMember!['id']);
        if (index != -1) {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      bottomNavigationBar: BottomNavigationBar(
        currentIndex: _selectedIndex > 2 ? 0 : _selectedIndex, // Ẩn tab chỉnh sửa
        onTap: (index) {
          setState(() {
  ...
  void _showMemberDetails(BuildContext context, Map<String, dynamic> member) {
    ...
    final Color roleColor = member['role'] == 'PHÓ CÂU LẠC BỘ' ? 
      Colors.green : (member['role'] == 'TRƯỞNG CÂU LẠC BỘ' ? Colors.orange : Colors.blue);
          ...
          child: Container(
            ...
            child: Column(
              ...
              children: [
                ...
                Container(
                  padding: const EdgeInsets.all(AppConstants.paddingLarge),                  decoration: BoxDecoration(
                      ...
                      Hero(
                        ...
                        child: Container(
                          ...
                          decoration: BoxDecoration(
                            ...
                            boxShadow: [
                              BoxShadow(
                                color: genderColor.withAlpha((0.3 * 255).round()),
                                blurRadius: 8,
      ...
      child: Row(
        children: [
          Container(
            ...
            decoration: BoxDecoration(
              color: (iconColor ?? AppConstants.primaryColor).withAlpha((0.1 * 255).round()),
                ...
                child: Column(
                  children: [
                    ...
                    DropdownButtonFormField<String>(
                      ...
                      items: ['THÀNH VIÊN', 'PHÓ CÂU LẠC BỘ', 'TRƯỞNG CÂU LẠC BỘ'].map((String value) {
                        return DropdownMenuItem<String>(
                          value: value,
                          child: Text(value),
                        );
                ...
                child: SingleChildScrollView(
                  child: Column(
                    ...
                    children: [
                      ...
                      _buildDropdownField('Lớp', ['Tất cả', '10A1', '10A9', '10A11', '11B6', '11B9', '11B10', '12A3', '12A6', '12A7', '12A16']),
                      const SizedBox(height: AppConstants.paddingMedium),
                      _buildDropdownField('Giới tính', ['Tất cả', 'Nam', 'Nữ']),
                      const SizedBox(height: AppConstants.paddingMedium),
                      _buildDropdownField('Chức vụ', ['Tất cả', 'THÀNH VIÊN', 'PHÓ CÂU LẠC BỘ', 'TRƯỞNG CÂU LẠC BỘ']),
                      const SizedBox(height: AppConstants.paddingLarge),
                      ...
                      SizedBox(
                        height: 300, // Chiều cao cố định cho phần kết quả tìm kiếm
                        child: _filteredMembers.isEmpty 
                          ? const Center(
                              child: Text(
                                'Không tìm thấy thành viên',
                              ...
                              itemBuilder: (context, index) {
                                ...
                                return ListTile(
                                  leading: CircleAvatar(
                                    backgroundColor: member['gender'] == 'Nam' ? 
                                      Colors.blue.withAlpha(51) : 
                                      Colors.pink.withAlpha(51),
                                    child: Text(
                                      _getInitials(member['name']),
                                      style: TextStyle(
                                        color: member['gender'] == 'Nam' ? Colors.blue : Colors.pink,
                                        fontWeight: FontWeight.bold,
                                      ),
                                    ),
                                  ),
                                  title: Text(member['name'] ?? ''),
                                  subtitle: Text('${member['id'] ?? '-'} - ${member['class'] ?? '-'}'),
                                  trailing: Container(
                                    padding: const EdgeInsets.symmetric(
                                      horizontal: 8,
                                      vertical: 4,
